...
from attendance_portal.analytics.models import Student, Course, Enrollment
import pandas as pd
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        file_path = 'C:/Users/rahul/Desktop/msc final year project/Analyze_It/Data/new.xlsx' 
        ...
        for _, row in df.iterrows():
            ...
            try:
                ...
                print(f"Course not found for code {course_code} (student {user_id})")
                continue
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully {count_students} students and {count_enrollments} enrollments with stats.')) 